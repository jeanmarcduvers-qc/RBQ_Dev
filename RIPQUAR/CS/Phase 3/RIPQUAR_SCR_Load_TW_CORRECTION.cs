...
namespace ST_TW_CORRECTION
{
    ...
    {
        private string logFile = @"C:\Temp\TW_CORRECTION_LOG.txt";
        ...
        public void Main()
        {
            try
            {
                ...
                File.WriteAllText(logFile, $"=== DÉBUT TW_CORRECTION - {DateTime.Now} ===\n\n");
                ...
                {
                    Log("ATTENTION: Aucune copie dans TW_COPIE - Impossible de charger TW_CORRECTION!");
                    MessageBox.Show("ATTENTION: Table TW_COPIE est vide!\n\nVeuillez charger TW_COPIE AVANT TW_CORRECTION.");
